function simulateAMB() 
    ...
    % Save paramaeters:
    filename = 'C:\Users\Jonah\Documents\MAE 4730\MAE 4730\Homework\Final Project\Thetas_To_Compare\paramAMB' ;
    mat = p ;
    save( filename, 'mat' ) ;
    ...
    plot( x2, y2 ) ;
    plot( x3, y3 ) ;
    title( 'AMB Trajectory of Each Link' ) ;
    xlabel( 'X-Position' ) ;
    ylabel( 'Y-Position' ) ;
    ...
    title( 'AMB Triple Pendulum Animation' ) ;
    xlabel( 'X-Position' ) ;
    ylabel( 'Y-Position' ) ;
